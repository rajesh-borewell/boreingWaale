        ...
        <div className="relative min-h-screen bg-black overflow-x-hidden pt-32 pb-20 px-4">
            ...
            >
                ...
                <div className="hud-card hologram-border rounded-3xl overflow-hidden backdrop-blur-3xl bg-black/40">
                    ...
                    {/* Header */}
                    <div className="bg-indigo-500/10 border-b border-white/5 p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                <Zap className="w-5 h-5 text-indigo-400 glow-violet" />
                                <span className="text-[10px] font-mono text-indigo-300 tracking-[0.4em] uppercase">Void Manifest 001</span>
                            </div>
