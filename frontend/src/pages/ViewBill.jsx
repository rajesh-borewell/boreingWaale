                        ...
                        {!isEditing ? (
                            <>
                                <button
                                    ...
                                    className="col-span-2 lg:col-span-1 flex items-center justify-center gap-2 bg-indigo-500/10 text-indigo-400 border border-indigo-500/30 px-6 py-2.5 rounded-xl font-mono text-[11px] tracking-widest hover:bg-indigo-500 hover:text-white transition-all uppercase"
                                >
                                ...
                                <button
                                    ...
                                    className="col-span-2 sm:col-span-1 lg:col-span-1 flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-2.5 rounded-xl font-mono text-[11px] tracking-widest shadow-lg hover:shadow-emerald-500/20 transition-all uppercase"
                                >
